...
use Zero\Lib\Console\Commands\MakeJobCommand;
use Zero\Lib\Console\Commands\QueueFlushCommand;
use Zero\Lib\Console\Commands\QueueForgetCommand;
use Zero\Lib\Console\Commands\QueueRetryCommand;
use Zero\Lib\Console\Commands\QueueTableCommand;
...
final class Application
{
    ...
    public function __construct()
    {
        ...
        $this->addCommand(new ScheduleListCommand());
        $this->addCommand(new QueueWorkCommand());
        $this->addCommand(new QueueRetryCommand());
        $this->addCommand(new QueueForgetCommand());
        $this->addCommand(new QueueFlushCommand());
