...
<div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-stone-900">Add a client</h1>
        </div>
    ...
    <div class="rounded-xl border border-stone-200 bg-white px-6 py-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('clients.store') }}" class="mt-6 grid gap-4 lg:grid-cols-2">
            ...
            <div class="flex items-center justify-end gap-3 lg:col-span-2">
                <a href="{{ route('clients.index') }}" class="rounded-xl border border-stone-200 px-5 py-2 text-sm font-semibold text-stone-600 hover:bg-stone-50">
                    Cancel
                </a>
