...
<div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-stone-900">Edit client</h1>
        </div>
    ...
    <div class="rounded-xl border border-stone-200 bg-white px-6 py-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('clients.update', ['client' => $client['id']]) }}" class="mt-6 grid gap-4 lg:grid-cols-2">
