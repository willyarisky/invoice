...
<div class="space-y-6">
    ...
    @if ($linkedInvoice)
        @include('components/alerts', [
            'alertInfoMessage' => 'This transaction is linked to invoice ' . ($transaction['invoice_no'] ?? '') . '.',
        ])
    @endif

    <div class="rounded-xl border border-stone-200 bg-white px-6 py-6 shadow-sm">
        @include('components/alerts', [
            'alertErrorMessage' => 'Please review the transaction fields.',
            'alertErrorClass' => 'mt-2',
        ])
