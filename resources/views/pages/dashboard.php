...
@section('content')
<div class="rounded-lg border border-stone-200 bg-white px-6 py-6 text-sm text-stone-600 shadow-sm">
    ...
    <form method="POST" action="{{ route('auth.logout') }}" class="mt-4 inline-flex">
        <button type="submit" class="rounded-lg border border-stone-200 px-4 py-2 text-sm font-semibold text-stone-700 hover:bg-stone-50">Log out</button>
    </form>
</div>
@endsection
